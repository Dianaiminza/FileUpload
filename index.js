...
//         }
//             else if (files.every(file => file.mimetype == 'file/png' || file.mimetype == 'file/jpg' || file.mimetype == 'file/jpeg')) {
//               return next()    
//             } 
//             else {   
//               return res.json({
...
// }
function fileFilter (req,res,next) {
    // console.log((file.every(file.mimetype == "file/png" || file.mimetype == "file/jpg" || file.mimetype == "file/jpeg")));
    console.log(req.files);
    let files= req.files;
            if (!req.files.length) {
        return res.json({
